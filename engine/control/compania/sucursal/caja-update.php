<?php
    ...
    if(Sistema::usuarioLogueado()){
        if(isset($_POST)){
            ...
            Alert::mensaje($mensaje);
            Sistema::debug('error', 'engine > control > compania > sucursal > caja-update.php - Error al recibir la información del formulario.');
        }
    }else{
        Sistema::debug('error', 'engine > control > compania > sucursal > caja-update.php - Usuario no logueado.');
    }
?>