<?php
    ...
    if(Sistema::usuarioLogueado()){
        if(isset($_POST)){
            ...
            Compania::sucursalPedidoFormularioProductoFiltrar($data);
        }else{
            $mensaje['tipo'] = 'danger';
        ...
        Sistema::debug('error', 'includes > compania > sucursal-pedido-formulario-producto-filtrar.php - Usuario no logueado.');
    }
?>